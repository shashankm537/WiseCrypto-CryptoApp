                  ...
                  child: Container(
                    ...
                    child: Column(
                      children: [
                        _buildScreenTitle(
                          context,
                          screenTitle: "0. First Screen".tr,
                          onTapScreenTitle: () =>
                              onTapScreenTitle(AppRoutes.firstScreen),
                        ),
                        _buildScreenTitle(
                          context,
                          screenTitle: "1. Login".tr,
                          onTapScreenTitle: () =>
                              onTapScreenTitle(AppRoutes.loginScreen),
                        ),
                        _buildScreenTitle(
                          context,
                          screenTitle: "2. Register Data ".tr,
                          onTapScreenTitle: () =>
                              onTapScreenTitle(AppRoutes.registerDataScreen),
                        ),
                        _buildScreenTitle(
                          context,
                          screenTitle: "2. Register Data One".tr,
                          onTapScreenTitle: () =>
                              onTapScreenTitle(AppRoutes.registerDataOneScreen),
                        ),
                        _buildScreenTitle(
                          context,
                        ...
                        _buildScreenTitle(
                          context,
                          screenTitle: "Transaction List - Tab Container".tr,
                          onTapScreenTitle: () => onTapScreenTitle(
                              AppRoutes.transactionListTabContainerScreen),
                        ),
                        _buildScreenTitle(
                          context,
                        ...
                        _buildScreenTitle(
                          context,
                          screenTitle: "Payment Options".tr,
                          onTapScreenTitle: () =>
